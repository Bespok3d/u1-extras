...
each `.b3`, cuts a release per plugin, assembles this repo's `index.json` sub-list as `U1 Extras`,
and registers it in `Bespok3d/main-index` (`lists/<repo>.json`). Secrets: `MAIN_INDEX_TOKEN`
